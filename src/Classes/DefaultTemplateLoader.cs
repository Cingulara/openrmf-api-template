    ...
    public static class DefaultTemplateLoader
    {
        ...
        private static Template MakeTemplateSystemRecord(string rawChecklist, string filename) {
            ...
            foreach (XmlNode node in nodeListing) {
                ...
                vulnitem.STIG_DATA.Add(new STIG_DATA() {VULN_ATTRIBUTE = "Vuln_Discuss", ATTRIBUTE_DATA = vulnListing.Vuln_Discuss}); 
                vulnitem.STIG_DATA.Add(new STIG_DATA() {VULN_ATTRIBUTE = "IA_Controls", ATTRIBUTE_DATA = vulnListing.IA_Controls});
                vulnitem.STIG_DATA.Add(new STIG_DATA() {VULN_ATTRIBUTE = "Check_Content", ATTRIBUTE_DATA = vulnListing.Check_Content});
                vulnitem.STIG_DATA.Add(new STIG_DATA() {VULN_ATTRIBUTE = "Fix_Text", ATTRIBUTE_DATA = vulnListing.Fix_Text}); 
